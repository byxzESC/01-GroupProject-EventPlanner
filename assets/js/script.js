// ticketmaster URL 'https://app.ticketmaster.com/discovery/v2/events.json?city='+ {city} +'&countryCode=US&apikey=9guoY8HVvZn5Dz76zhZz9omQCGJGNs7n'
// open meteo URL 'https://api.open-meteo.com/v1/forecast?latitude=' + {latitude} + '&longitude=' + {longitude} + '&daily=weathercode&timezone=auto'
